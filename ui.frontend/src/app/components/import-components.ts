 ...
 */
MapTo('eds-aem-spa/components/navigation')(NavigationV1Component, {isEmpty: NavigationV1IsEmptyFn});
MapTo('eds-aem-spa/components/separator')(SeparatorV1Component);

MapTo('eds-aem-spa/components/container')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});
MapTo('eds-aem-spa/components/experiencefragment')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});

MapTo('eds-aem-spa/components/download')(DownloadV1Component,{isEmpty: DownloadV1IsEmptyFn});
MapTo('eds-aem-spa/components/languagenavigation')(LanguageNavigationV1Component);
MapTo('eds-aem-spa/components/list')(ListV2Component, {isEmpty: ListV2IsEmptyFn});
MapTo('eds-aem-spa/components/breadcrumb')(BreadCrumbV2Component, {isEmpty: BreadCrumbV2IsEmptyFn});
MapTo('eds-aem-spa/components/button')(ButtonV1Component, {isEmpty: ButtonV1IsEmptyFn});
MapTo('eds-aem-spa/components/image')(ImageV2Component, {isEmpty: ImageV2IsEmptyFn});
MapTo('eds-aem-spa/components/title')(TitleV2Component, {isEmpty: TitleV2IsEmptyFn});

MapTo('eds-aem-spa/components/accordion')(AccordionV1Component);
MapTo('eds-aem-spa/components/tabs')(TabsV1Component);
...
LazyMapTo('eds-aem-spa/components/teaser')(TeaserV1Component);
...
LazyMapTo('eds-aem-spa/components/carousel')(CarouselV1Component);
...
LazyMapTo('eds-aem-spa/components/text')(LazyTextModule, TextEditConfig);