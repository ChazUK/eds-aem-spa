 ...
 */
MapTo('eds-aem-app/components/navigation')(NavigationV1Component, {isEmpty: NavigationV1IsEmptyFn});
MapTo('eds-aem-app/components/separator')(SeparatorV1Component);

MapTo('eds-aem-app/components/container')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});
MapTo('eds-aem-app/components/experiencefragment')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});

MapTo('eds-aem-app/components/download')(DownloadV1Component,{isEmpty: DownloadV1IsEmptyFn});
MapTo('eds-aem-app/components/languagenavigation')(LanguageNavigationV1Component);
MapTo('eds-aem-app/components/list')(ListV2Component, {isEmpty: ListV2IsEmptyFn});
MapTo('eds-aem-app/components/breadcrumb')(BreadCrumbV2Component, {isEmpty: BreadCrumbV2IsEmptyFn});
MapTo('eds-aem-app/components/button')(ButtonV1Component, {isEmpty: ButtonV1IsEmptyFn});
MapTo('eds-aem-app/components/image')(ImageV2Component, {isEmpty: ImageV2IsEmptyFn});
MapTo('eds-aem-app/components/title')(TitleV2Component, {isEmpty: TitleV2IsEmptyFn});

MapTo('eds-aem-app/components/accordion')(AccordionV1Component);
MapTo('eds-aem-app/components/tabs')(TabsV1Component);
...
LazyMapTo('eds-aem-app/components/teaser')(TeaserV1Component);
...
LazyMapTo('eds-aem-app/components/carousel')(CarouselV1Component);
...
LazyMapTo('eds-aem-app/components/text')(LazyTextModule, TextEditConfig);