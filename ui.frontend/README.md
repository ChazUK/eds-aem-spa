...
After running `npm start` **in the `ui.frontend` directory**, your app will be automatically opened in your browser (at path http://localhost:4200/content/eds-aem-spa/GB/en/home.html). If you make edits, the page will reload.
...
##### 2: the express code consumes the JSON and returns pre-rendered HTML over
##### 3: the servlet puts this inside the HTML
##### 4: the angular app detects the pre-rendered HTML and hydrates the app instead of rendering it:
